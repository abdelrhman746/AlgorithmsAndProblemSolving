...
bool FindClientByAccountNumberandPrintAccountData(stBankClientData & Clientinfo, string FileName,string AccountNumber)
{

    vector<stBankClientData> vClient = LoadClientsDataFromFile(FileName);
...
int main()
{
    ...
    stBankClientData Clientinfo;
    if (FindClientByAccountNumberandPrintAccountData(Clientinfo, ClientsFileName, AccountNumber))
    {
        cout << "The following are the client details" << endl;
        printBankClientRecord(Clientinfo);
    }
    else
    {
        cout << "Clientwith Account Number (" << AccountNumber << ") Not Foound!";
    }
