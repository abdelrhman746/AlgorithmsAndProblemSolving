...
int main()
{
    string S1 = "             Abdelrhman Hossam              ";
    cout << "String      = " << S1 << endl;
    cout << "Trim Left   = " << TrimDelim(S1,enWhatToTrim::enTrimLeft) << endl;
    cout << "Trim Right  = " << TrimDelim(S1,enWhatToTrim::enTrimRight) << endl;
    cout << "Trim        = " << TrimDelim(S1,enWhatToTrim::enTrimAll) << endl;
    return 0;
}
