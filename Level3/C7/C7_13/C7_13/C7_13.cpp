...
int main()
{
    ...
    if (CheckIdentityMatrix(Array1, 3, 3))
    {
        cout << "\nYes: Matrix1 is Identity Matrix" << endl;
    }
    else
    {
        cout << "\nNo: Matrix1 is Not Identity Matrix" << endl;
    }

    if (CheckIdentityMatrix(Array2, 3, 3))
    {
        cout << "\nYes: Matrix2 is Identity Matrix" << endl;
    }
    else
    {
        cout << "\nNo:  Matrix2 is Not Identity Matrix" << endl;
    }
