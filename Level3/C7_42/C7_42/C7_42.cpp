...
string ReplaceWords(string S1, string StringToReplace, string ReplaceTo,string Delim=" ")
{
    vector<string> vString;
    vString = SplitString(S1,Delim);
    for (string& s : vString)
...
int main()
{
    string S1 = { "Welocome to Egypt , Egypt is a nice country" };
    
    cout << "Original String :" << endl;
    cout << S1 << endl;

   /* S1=ReplaceWords(S1, "Egypt","USA");
    cout << "String After Replace:" << endl;
    cout << S1 << endl;*/

    S1 = ReplaceWordInStringUsingBuiltInFunction(S1, "Egypt", "USA");
    cout << "String After Replace:" << endl;
    cout << S1 << endl;
