...
bool CheckNumberExistInMatrix(int Array[3][3], int ArrayLength, int ArrayWidth, int Number)
{
    for (int i = 0; i < ArrayLength; i++)
    {
        for (int j = 0; j < ArrayWidth; j++)
...
void PrintIntersectedNumbers(int Array1[3][3], int ArrayLength, int ArrayWidth, int Array2[3][3])
{
    ...
    for (int i = 0; i < ArrayLength; i++)
    {
        for (int j = 0; j < ArrayWidth; j++)
        {
            if (CheckNumberExistInMatrix(Array2, ArrayLength, ArrayWidth, Array1[i][j]))
            {
...
int GetMinimumNumberInMatrix(int Array[3][3], int ArrayLength, int ArrayWidth)
{
    int min = Array[0][0];
    for (int i = 0; i < ArrayLength; i++)
    {
...
int GetMaximumNumberInMatrix(int Array[3][3], int ArrayLength, int ArrayWidth)
{
    int max = Array[0][0];
    for (int i = 0; i < ArrayLength; i++)
    {
...
bool CheckMatrixPalindrome(int Array[3][3], int ArrayLength, int ArrayWidth)
{
    for (int i = 0; i < ArrayLength; i++)
    {
        for (int j = 0; j < ArrayWidth / 2; j++)
        {
            if (Array[i][j] != Array[i][ArrayWidth - j - 1])
            {
                return false;
            }
        }
...
int main()
{
    ...
    if (CheckMatrixPalindrome(Array1, 3, 3))
    {
