...
int CountEvenNumbers(int Array1[100],int ArrayLength)
{
    int Counter=0;
    for(int i=0;i<ArrayLength;i++)
    {
...
void PrintRandomElementsOfArrayAndCountOfEvenNumbers(int ArrayLength)
{
    int Array1[100];
    int Array2[100];
    int ArrayLength2=0;
    ...
    cout<<"Even Numbers count is: "<<CountEvenNumbers(Array1,ArrayLength)<<endl;
}
int main ()
{
    //Seeds the random number generator in C++, called only once
    srand((unsigned)time(NULL));
    PrintRandomElementsOfArrayAndCountOfEvenNumbers(ReadPostiveNumber("Enter the Number Of elements"));
